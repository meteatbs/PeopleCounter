...
namespace CP_Serial_Port_Terminal
{
    public partial class Form1 : Form
    {
        ...
        double num1, num2Total, num3PeoEntry, num4PeoExit,rate,upEnter,upExit,upRate,upTotalPeople;
        ...
        private void ShowData(object sender, EventArgs e)
        {
            ...
            else if(toolStripComboBox1.Text == "Add to Old Data")
            {
                if(toolStripComboBox3.Text == "TOP")
                {
                    ...
                    dt.Rows.Add(info, num2Total, num1, num3PeoEntry, num4PeoExit);
